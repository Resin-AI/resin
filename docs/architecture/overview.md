...
- Every recorded-program publication requires a successful fresh-process replay bound to the exact final plan, including workflows with no parameter candidates. The original baseline proves replay, not an independent held-out example or a proposed binding.
