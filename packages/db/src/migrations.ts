...
/**
 * Migration 004: Add local opportunity-engine tables for deterministic signature
 * detection, workflow clustering, hash suppression cache, and the pattern outbox.
 */
